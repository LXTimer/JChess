...
public class TitlePanel extends JPanel {
    ...
    private void showControlsDialog() {
        String message = "<html><div style='width: 420px; font-family: Roboto;'>"
                ...
                + "<b>Basic Play</b><br>"
                + "- Click to move or drag to move<br>"
                + "- Use the move log to review previous moves.<br>"
                + "- Right-click to add annotation<br>"
                ...
                + "- Space: Best move (in analysis mode)<br>"
                + "<b>Local Multiplayer</b><br>"
                ...
                + "<b>vs Computer</b><br>"
                + "- Choose time and side.<br>"
                + "- Choose the level of Stockfish<br>"
                + "<b>Analysis Mode</b><br>"
                + "- Analyze positions through evaluation number and dynamic evaluation bar<br>"
                + "- Change evaluation settings by clicking on the settings button<br>"
                + "</div></html>";
